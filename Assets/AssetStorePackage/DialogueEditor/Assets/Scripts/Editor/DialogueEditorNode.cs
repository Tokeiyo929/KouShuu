...
namespace DialogueEditor
{
    ...
    public class UISpeechNode : UINode
    {
        ...
        public override void OnDraw()
        {
            ...
            if (!string.IsNullOrEmpty(SpeechNode.Text_En))
            {
                DrawInternalText("EN: " + SpeechNode.Text_En, SPRITE_SZ + 5, NAME_HEIGHT + NAME_PADDING + 15);
            }
        }
    ...
    public class UIOptionNode : UINode
    {
        ...
        public override void OnDraw()
        {
            ...
            // Text (English) - if available
            if (!string.IsNullOrEmpty(OptionNode.Text_En))
            {
                DrawInternalText("EN: " + OptionNode.Text_En, 0, 15);
            }
        }
