            ...
            else
            {
                ...
                if (CurrentlySelectedObject.Type == SelectableUI.eType.Node)
                {
                    ...
                    if (selectedNode is UISpeechNode)
                    {
                        ...
                        GUILayout.Label("Character Name (English)", EditorStyles.boldLabel);
                        node.Name_En = GUILayout.TextField(node.Name_En);
                        EditorGUILayout.Space();

                        GUILayout.Label("Dialogue (Chinese)", EditorStyles.boldLabel);
                        node.Text = GUILayout.TextArea(node.Text);
                        EditorGUILayout.Space();
                        
                        GUILayout.Label("Dialogue (English)", EditorStyles.boldLabel);
                        node.Text_En = GUILayout.TextArea(node.Text_En);
                        EditorGUILayout.Space();
                    ...
                    else if (selectedNode is UIOptionNode)
                    {
                        ...
                        GUILayout.Label("Option text (Chinese):", EditorStyles.boldLabel);
                        node.Text = GUILayout.TextArea(node.Text);
                        EditorGUILayout.Space();
                        
                        GUILayout.Label("Option text (English):", EditorStyles.boldLabel);
                        node.Text_En = GUILayout.TextArea(node.Text_En);
                        EditorGUILayout.Space();
