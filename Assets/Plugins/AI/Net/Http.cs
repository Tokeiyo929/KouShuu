...
namespace Duck.Http
{
	public sealed class Http : MonoBehaviour
	{
		...
		public static IHttpRequest Post(string uri, WWWForm formyData)
		{
			return Instance.service.Post(uri, formyData);
		}

		/// <see cref="Duck.Http.Service.IHttpService.Post(string, Dictionary&lt;string, string&gt;)"/>
		public static IHttpRequest Post(string uri, Dictionary<string, string> formyData)
		{
			return Instance.service.Post(uri, formyData);
		}
