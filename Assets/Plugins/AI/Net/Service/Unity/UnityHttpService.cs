...
namespace Duck.Http.Service.Unity
{
    ...
    public class UnityHttpService : IHttpService
    {
        ...
        public IHttpRequest Post(string uri, WWWForm formyData)
        {
            return new UnityHttpRequest(UnityWebRequest.Post(uri, formyData));
        }

        public IHttpRequest Post(string uri, Dictionary<string, string> formyData)
        {
            return new UnityHttpRequest(UnityWebRequest.Post(uri, formyData));
        }
